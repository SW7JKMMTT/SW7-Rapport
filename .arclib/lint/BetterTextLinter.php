 ...
 */
final class BetterTextLinter extends ArcanistLinter {
  ...
  private $enableCharset = true;

  public function getInfoName() {
    return pht('Better Basic Text Linter');
  }
  ...
  public function getLinterConfigurationOptions() {
    $options = array(
      ...
      'text.charset' => array(
        'type' => 'optional bool',
        'help' => pht(
          'Enable or disable the checking of charset (characters outside '.
          'of ascii), Enabled by default.'),
      ),
    );
  ...
  public function setEnableCharset($new_state) {
    $this->enableCharset = $new_state;
    return $this;
  }
