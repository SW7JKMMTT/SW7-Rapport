...
Since we want to enable functional scalability, we don't want to limit the development of new system roles by artificially tying them to inheritance.
...
The \code{Permission}--class is used to grant permissions to which endpoints in the REST API a given user can use. 
