...
Another feature that fits in will with the rest of the technology stack is the integration with JAX-RS, which means that the various endpoint handers, or methods, can return object, and let the JAX-RS library handle the serialization.
