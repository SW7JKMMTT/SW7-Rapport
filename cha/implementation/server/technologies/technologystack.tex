...
Since we, as described in \fxnote{Ref til nogle krav}, want to keep track of vehicle positions, we will be storing vehicle location, which is geospatial data.
