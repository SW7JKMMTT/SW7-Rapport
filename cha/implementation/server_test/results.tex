...
\begin{figure}[!htb]
    ...
    \begin{subfigure}[b]{\textwidth}
        \footnotesize
        \centering
        \subimport{graphs/}{fetch_resp_dist_normal.tex}
        \caption{Response time distribution}\label{fig:fetch_resp_t_dist_normal}
    \end{subfigure}\\
    \begin{subfigure}[b]{\textwidth}
        \footnotesize
        \centering
        \subimport{graphs/}{fetch_reqs_normal.tex}
...
\begin{figure}[!htb]
    \begin{subfigure}[b]{\textwidth}
        \footnotesize
        \centering
        \subimport{graphs/}{fetch_resp_dist_heavy.tex}
        \caption{Response time distribution}\label{fig:fetch_resp_t_dist_heavy}
    \end{subfigure}\\
    \begin{subfigure}[b]{\textwidth}
        \footnotesize
        \centering
        \subimport{graphs/}{fetch_reqs_heavy.tex}
