...
This bottleneck will impair the load scalability of the system, which is defined in \myref{subsec:scalability_def},
...
as mentioned in \myref{subsec:scalability_def}.
