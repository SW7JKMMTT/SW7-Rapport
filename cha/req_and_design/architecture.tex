...
This results in both version and functional scalability realying on the server's internal architecture, which happens to be a layered architecure which faciliates low coupling and through low coupling functional scalability.
